...
public:
	...
	void dibujarTablaPuntajes(sf::RenderWindow& ventana, const sf::Font& fuente, const TablaPuntajes& tabla, const GestorTexturas& texturas, const std::string& algoritmoActual) const;
